...
import { boilerConfig, shellyEmConfig, solarConfig } from "../context/configurationContext";
import { Loader } from "lucide-react";

// Définition des time zone
const timezones = {
    "Africa/Abidjan":"GMT0",
    "Africa/Accra":"GMT0",
...
function SolarForm({ onSubmit, loading, boilerSettings, shellyEmSettings, solarSettings }: solarFormProps) {
  ...
  useEffect(() => {
    ...
    if (boilerSettings && shellyEmSettings && solarSettings) {
      ...
      if (timezoneRef.current) timezoneRef.current.value = solarSettings.timeZone || '';
    }
